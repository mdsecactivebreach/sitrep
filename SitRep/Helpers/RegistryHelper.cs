...
namespace SitRep.Helpers
{
    /// <summary>
    /// Mostly lifted from Seatbelt https://github.com/GhostPack/Seatbelt/blob/master/Seatbelt/Program.cs
    /// </summary>
    public static class RegistryHelper
    {
        public static bool CheckKeyExists(string hive, string path, string value)
        {
            var result = GetRegValue(hive, path, value);
            return result != null;
        }
